...
#### 미국의 휴머노이드 로봇 연구
- [[Atlas]]: Boston Dynamics에서 개발한 휴머노이드 개발
- [[Valkyrie]]: NASA에서 연구하는 휴머노이드
- **MIT**: [[Russ Tedrake]] 연구실의 휴머노이드 제어 및 동역학 연구
...
- **연구 활용**: MIT [[Russ Tedrake]] 연구실이 DARPA Robotics Challenge에서 사용
...
#### MIT 휴머노이드 연구 
- **연구책임자**: [[Russ Tedrake]] (Robot Locomotion Group)
- **주요 프로젝트**: DARPA Robotics Challenge, NASA Space Robotics Challenge
- **핵심 기술**: 언더액추에이티드 로보틱스, 실시간 최적화 제어, 인식-제어 통합
- **상세 내용**: [[Russ Tedrake]] 문서 참조
